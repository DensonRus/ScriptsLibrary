...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("ТестДолжен_ПроверитьПреобразованиеКБВыбраннойЕдинице");
...
Процедура ТестДолжен_ПроверитьПреобразованиеКБВыбраннойЕдинице() Экспорт
	
	// Выполним преобразование 
	Эталон = 0.742188;
	ЕдиницаДляПреобразования = ЕдиницыИзмерений.Мегабайт;
	
	Конвертер = Новый Конвертер(760,ЕдиницыИзмерений.Килобайт);

	Результат = Конвертер.Сконвертировать(ЕдиницыИзмерений.Мегабайт);

	Ожидаем.Что(Результат, "Ожидаем, что 760кб  равно 0.742188").Равно(Эталон);


	Эталон = 12824.01;
	ЕдиницаДляПреобразования = ЕдиницыИзмерений.Мегабайт;
	
	Конвертер = Новый Конвертер(13131789, ЕдиницыИзмерений.Килобайт);

	Результат = Конвертер.Сконвертировать(ЕдиницыИзмерений.Мегабайт, 2);

	Ожидаем.Что(Результат, "Ожидаем, что 13131789кб  равно 0.12824.01").Равно(Эталон);
